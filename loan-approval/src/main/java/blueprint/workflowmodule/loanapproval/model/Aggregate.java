 ...
 * model has no reason to get one: it runs from the start event through a single service
 * task to the end, and no expression in it reads the aggregate. What the BPMS holds is the
